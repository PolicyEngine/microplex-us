...
DATASET_OPTIONS = {
    ...
    # Microplex eCPS replacement (the deprecation target for policyengine-us-data).
    # REBASE HOOK: once the MP arch-calibrated dataset is promoted, point this at
    # it and set SELECTED_DATASET = "mp_2024". Path is a placeholder until promotion.
    "mp_2024": {
        "path": "hf://policyengine/microplex-us/mp_ecps_2024.h5",
        "base_year": 2024,
    },
}

# TODO(rebase): switch to "mp_2024" after MP promotion (eCPS is being deprecated).
